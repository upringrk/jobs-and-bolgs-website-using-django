...
SECRET_KEY = 'hm%syt0raqqi%%oleh^03^um_upcl1twlq6rw1&7+se@3u$mc%'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'project02/static/')
]
STATIC_ROOT = os.path.join(BASE_DIR, 'static')
STATIC_URL = '/static/'  # here  static name doesnot matter much
